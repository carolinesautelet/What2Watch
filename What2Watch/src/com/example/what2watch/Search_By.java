...
public class Search_By extends Activity {
	...
	{
		String queryString  = "SELECT M.rowid as _id, Name FROM Movie M, Actor A WHERE M.ID=A.ID and A.Name LIKE ? GROUP BY Name ORDER BY Name ASC";
		String[] display = {"Name"};
	...
	{
		String queryString  = "SELECT M.rowid as _id, Name FROM Movie M, Director D WHERE M.ID=D.ID and D.Name LIKE ? GROUP BY Name ORDER BY Name ASC" ;
		String[] display = {"Name"};
		String[] whereArgs = new String[] {String.valueOf(entree)};
